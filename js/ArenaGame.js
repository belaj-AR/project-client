...
export default class ArenaGame extends Component {
  ...
  setPlayerLose = () => {
    ...
    this.setState({
      player1: {
        name: this.props.arSceneNavigator.viroAppProps.players[0].name
      },
      player2: {
        name: this.props.arSceneNavigator.viroAppProps.players[1].name
      }
    })

    setTimeout( () => {
      this.setState({
       player1: { status : this.props.arSceneNavigator.viroAppProps.players[0].status },
       player2: { status : this.props.arSceneNavigator.viroAppProps.players[1].status }
      });
    }, 7000)
  }
